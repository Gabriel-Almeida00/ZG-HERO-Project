...
class VagaView {
    private CompetenciaVagaView competenciaVagaMenu
    ...
    VagaView(ConfigDatabase configDatabase) {
        ...
        competenciaVagaMenu = new CompetenciaVagaView(configDatabase)
    ...
    void listarVagas() {
        List<VagaDTO> vagas = vagaController.listarTodasVagas()
    ...
    void listarVagasDaEmpresa(Reader reader) {
        ...
        List<VagaDTO> vagas = vagaController.listarVagasDaEmpresa(id)
   ...
   void listarCandidatosQueCurtiramVaga(Reader reader){
       ...
       List<CandidatoQueCurtiuVagaDTO> candidatos = curtidaController.listarCandidatosQueCurtiramVaga(id)

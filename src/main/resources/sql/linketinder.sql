...
-- Inserir Candidatos
INSERT INTO candidatos (nome, sobrenome, dataNascimento, email, redeSocial , cpf, pais, cep, descricao, senha)
VALUES
  ('Candidato 1', 'Sobrenome 1', '1990-01-01', 'candidato1@email.com','lindln', '123.456.789-00', 'Brasil', '12345-678', 'Descrição do Candidato 1', 'senha123'),
  ('Candidato 2', 'Sobrenome 2', '1985-05-10', 'candidato2@email.com','lindln', '987.654.321-00', 'Brasil', '98765-432', 'Descrição do Candidato 2', 'senha456'),
  ('Candidato 3', 'Sobrenome 3', '1998-08-20', 'candidato3@email.com','lindln', '555.555.555-00', 'Brasil', '55555-555', 'Descrição do Candidato 3', 'senha789'),
  ('Candidato 4', 'Sobrenome 4', '1992-03-15', 'candidato4@email.com','lindln', '111.111.111-00', 'Brasil', '11111-111', 'Descrição do Candidato 4', 'senhaabc'),
  ('Candidato 5', 'Sobrenome 5', '1987-11-30', 'candidato5@email.com','lindln', '999.999.999-00', 'Brasil', '99999-999', 'Descrição do Candidato 5', 'senhaxyz');
